...
const data = [
  ...
  { id: '4', name: 'Syndrome Bar', top: '44.7%', left: '64%', rubricId: '4', price: '', description: 'Бар в уютном дворе на главной площади Екатеринбурга. Частые концерты, вечеринки и стендапы от Fresh Stand-Up. Пиво и сидры от лучших независимых пивоварен. Бургеры и снэки, в том числе веган опции', address: '8 Марта, 13', link: 'https://vk.com/syndromebar', isOpened: false, map: <iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3A1a792856df136564ff5058a4f1d1aaa34b379753cabb8f7527bba1328e5208e3&amp;source=constructor" width="100%" height="100%" frameborder="0"></iframe> },
  ...
  { id: '8', name: 'Переход у ТЮЗа', top: '16%', left: '71.3%', rubricId: '8', description: 'Здесь собираются музыканты, которые своим творчеством и приятной акустикой скрашивают вечера гуляющим екатеринбуржцам', address: 'Карла Либнехта, 48', isOpened: false, map: <iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3A3502878fe5588a00aee91e97ff8059f707e9bb247a5ff6be79f43ee41f6f225f&amp;source=constructor" width="100%" height="100%" frameborder="0"></iframe> },
